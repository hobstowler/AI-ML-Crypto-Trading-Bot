...
class DatastoreWrapper():
    ...
    def create_transaction(self, step: int, transaction_type: str, session_id: int = None, **values) -> int:
        ...
        print("Collecting key value pairs")
        value_string = ''
        for key, val in values.items():
            value_string += f'{key}={val},'
        value_string = value_string[:-1]

        print("Updating data values")
        data = {}
        data.update({
            "step": step,
...
if __name__ == '__main__':
    ...
    #     "type": "inference",
    #     "starting_balance": 9802.42350348,
    #     "starting_coins": 1.009,
    #     "crypto_type": "BTC",
    #     "model_name": "LSTM",
    # })
    ...
    #transaction_id = client.buy_crypto(1, .001, 20, 6209583034925056)
    #print(transaction_id)
    # Get the session transactions
    print(client.get_session_transactions(6209583034925056))

    # Delete all transactions
    for transaction in client.get_session_transactions(6209583034925056):
        client.delete_transaction(transaction['id'], 6209583034925056)
