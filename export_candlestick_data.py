...
HELP_MESSAGE = "\nUSAGE:"\
    "\npython3 export_candlestick_data.py ticker start_date_in_YYYY-MM-DD end_date_in_YYYY-MM-DD interval export_filepath"\
    "\n"

def export_candlestick_data(arguments: list):
    binance = BinanceAPI()
    data = binance.get_candlestick_dataframe(arguments[0], (arguments[1]), (arguments[2]), int(arguments[3]))
