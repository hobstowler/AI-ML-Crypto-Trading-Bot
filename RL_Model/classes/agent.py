...
class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=0.0003,
                 ...
                 actor_file='actor_ppo_', critic_file='critic_ppo_'):
        self.gamma = gamma
        self.policy_clip = policy_clip
        self.n_epochs = n_epochs
        self.gae_lambda = gae_lambda

        self.actor = ActorNetwork(n_actions=n_actions, input_dims=input_dims, alpha=alpha, file_name=actor_file)
        self.critic = CriticNetwork(input_dims=input_dims, alpha=alpha, file_name=critic_file)
